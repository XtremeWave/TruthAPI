...
public sealed class TMPTemplate
{
    ...
    public static void SetBase(TextMeshPro tmp)
    {
        ...
        baseTMP = UnityEngine.Object.Instantiate(tmp);
        UnityEngine.Object.Destroy(baseTMP.GetComponent<AspectPosition>());
        UnityEngine.Object.DontDestroyOnLoad(baseTMP);
    ...
    )
    {
        var replicatedObject = !parent
            ? UnityEngine.Object.Instantiate(baseTMP)
            : UnityEngine.Object.Instantiate(baseTMP, parent);
